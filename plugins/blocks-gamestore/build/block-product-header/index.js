...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"blocks-gamestore/product-header","version":"0.1.0","title":"Shop Archive Header","category":"gamestore","icon":"smiley","description":"News Header Block","example":{},"supports":{"html":false},"attributes":{"title":{"type":"string"},"image":{"type":"string"}},"textdomain":"blocks-gamestore","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
// так как это динамический блок, то этот файл использовать не будем
